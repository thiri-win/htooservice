		...
		<table class="kt_datatable m-3" id="html_table" width="100%">
			...
			<tbody>
				...
				<tr>
					...
					<td class="row">
						@if ($position->trashed())
						<a href="{{ route('positions.restore', $position->id ) }}" class="mr-2"><i class="flaticon2-reload-1"></i></a>
						@else
						<a href="{{ route('positions.edit', $position->id ) }}" class="mr-2"><i class="flaticon-edit"></i></a>
